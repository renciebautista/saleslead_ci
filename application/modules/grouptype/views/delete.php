<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Delete '<?php echo $grouptype['grouptype_desc']; ?>' Group Type</h1>				
	</div>
	<!-- /.col-lg-12 -->						
</div>
<!-- /.row -->
	...
	<div class="col-lg-6">
		...
		<?php echo form_hidden('_id', $grouptype['id']); ?>
			<div class="form-group">
				...
				<input id="grouptype" class="form-control" type="text" value="<?php echo set_value('grouptype',$grouptype['grouptype_desc'] ); ?>" name="grouptype" placeholder="Group Type" readonly="">
			</div>
