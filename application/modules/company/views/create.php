				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input id="lot" class="form-control" type="text" value="" name="lot" placeholder="Lot / Blk / House No. / Unit No.">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input id="street" class="form-control" type="text" value="" name="street" placeholder="Street">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<div class="form-group">
							...
							<input id="brgy" class="form-control" type="text" value="" name="brgy" placeholder="Brgy. / Subdivision">
						</div>
					</div>
				</div>
