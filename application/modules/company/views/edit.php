...
<div class="row">
	...
	<div class="col-lg-6">
			<div class="form-group">
				...
				<input id="company_name" class="form-control" type="text" value="<?php echo set_value('company_name',$company['company']); ?>" name="company_name" placeholder="Company Name">
			</div>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input value="<?php echo set_value('lot',$company['lot']); ?>" id="lot" class="form-control" type="text" value="" name="lot" placeholder="Lot / Blk / House No. / Unit No.">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input value="<?php echo set_value('street',$company['street']); ?>" id="street" class="form-control" type="text" value="" name="street" placeholder="Street">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<div class="form-group">
							...
							<input value="<?php echo set_value('brgy',$company['brgy']); ?>" id="brgy" class="form-control" type="text" value="" name="brgy" placeholder="Brgy. / Subdivision">
						</div>
					</div>
				</div>
				...
				<?php foreach ($companytypes as $companytype):?>
					<div class="checkbox">
						<label>
							<input type="checkbox" id="companytype[]" name="companytype[]" value="<?php echo $companytype['id']; ?>" <?php echo set_checkbox('companytype[]', $companytype['id'],(in_array($companytype['id'],$company_types) ? TRUE:FALSE)); ?> /><?php echo $companytype['companytype']; ?>
						</label>
					</div>
				<?php endforeach; ?>
				<?php endif; ?>
