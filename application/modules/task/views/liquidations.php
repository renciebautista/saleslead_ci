		...
		<div id="tab">
			<ul class="nav nav-tabs" role="tablist">
			  	<li><a href="<?php echo base_url('task/details/'.$project['id']); ?>" role="tab">Task History</a></li>
			   	...
			   	<li class="active"><a href="<?php echo base_url('task/liquidations/'.$project['id']); ?>" s="tab">Material / Cash Liquidations</a></li>
			</ul>
		</div>
			...
			<div id="specifications">
				<div class="panel panel-default">
					<div class="panel-heading">
						<i class="fa fa-money"></i> Material / Cash Liquidations
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
									<div class="pull-right">
										<a href="<?php echo base_url('task/addliquidations/'.$project['id']); ?>" class="btn btn-success"><i class="fa fa-plus"></i>  Liquidations</a>		
									</div>
								</div>
							...
							<div class="col-lg-12">
								...
								<div class="table-responsive">
									<table class="table table-hover">
										...
										<?php else: ?>
										<?php foreach ($liquidations as $task):?>
											<tr>
												<td>
