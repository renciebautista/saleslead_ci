	...
	<div class="col-lg-12 header-button">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-share-alt"></i> Notifications
				<?php if(!empty($notifications)): ?>
				<div class="pull-right">
					<div class="btn-group">
						<a href="<?php echo base_url('dashboard/clearnotifications'); ?>"> Clear All</a>
					</div>
				</div>
				<?php endif ?>
			</div>
			...
			<div class="panel-body">
				...
				<?php foreach ($notifications as $notification):?>
					...
					<?php if($notification['remarks'] == 'alert alert-success alert-dismissable'): ?>
					...
					<?php else: ?>
						 <div class=" <?php echo $notification['remarks'];  ?>">
						<a class="close" data-dismiss="alert" aria-hidden="true" href="<?php echo base_url('dashboard/joinedcontacts/'.$notification['id']); ?>">&times;</a>
						Your contact, <strong><?php echo strtoupper($notification['last_name'].', '.$notification['first_name'].' '.$notification['middle_name']); ?></strong> joined the <strong><?php echo strtoupper($notification['project_name']); ?></strong> project as <strong><?php echo $notification['grouptype_desc']; ?></strong> is denied.
					</div>
					<?php endif ?>
				<?php endforeach; ?>
				<?php else: ?>
