		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="list-group">
					...
					<?php if(count($request_approval) > 0): ?>
						<?php $not = true; ?>
					<a class="list-group-item" href="<?php echo base_url('request/approval'); ?>">
						<i class="fa fa-file-text fa-fw"></i>
						<?php echo count($request_approval); ?> Request Approval
						<span class="pull-right text-muted small">
							<em><?php echo distance_of_time_in_words(strtotime($request_approval[0]['updated_at']),strtotime(date('Y-m-d H:i:s'))); ?> ago</em>
						</span>
					</a>
					<?php endif; ?>
