<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">'<?php echo $requesttype['requesttype']; ?>' Releaser List</h1>	
	...
	<div class="col-lg-12">
		<?php echo form_open('',array('role' => 'search', 'method' => 'get' , 'class' => 'form-validate')); ?>
			<div class="pull-right">
				<a href="<?php echo base_url('requesttype/addreleaser/'.$requesttype['id']); ?>" class="btn btn-success"><i class="fa fa-plus"></i>  Releaser</a>		
			</div>
