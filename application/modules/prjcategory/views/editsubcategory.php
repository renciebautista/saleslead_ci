<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Edit '<?php echo $subcategory['prjsubcategory_desc']; ?>' Sub Category</h1>	
	...
	<div class="col-lg-6">
		...
		<?php echo form_hidden('_id', $subcategory['id']); ?>
			...
			<div class="form-group">
				...
				<input id="subcategory" class="form-control" type="text" value="<?php echo $subcategory['prjsubcategory_desc']; ?>" name="subcategory" placeholder="Sub Category">
			</div>
